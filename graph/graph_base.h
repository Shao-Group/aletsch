...
public:
	...
	virtual int bfs(int s, vector<int> &v, vector<int> &b, const set<int> &fb);
	...
	// draw
	virtual int draw(const string &file, const MIS &mis, const MES &mes, double len, bool footer) = 0;
