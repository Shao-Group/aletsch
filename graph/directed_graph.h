...
public:
	...
	virtual int bfs_reverse(int t, vector<int> &v, vector<int> &b, const set<int> &fb);
	...
	int draw(const string &file, const MIS &mis, const MES &mes, double len, const vector<int> &topo, bool footer);
};
