...
vector<trans_item*> merge_sorted_trans_items(vector<trans_item*> &vx, vector<trans_item*> &vy, int mode, double single_exon_overlap);
...
public:
	...
	int absorb(transcript_set &ts, int mode);
